...
API Key: the API Key where WISE-PaaS/Notification setting would used.  ![](/assets/13_SMS intrgrations.png)Reporting : check the report \(all messages sent and received history\)
